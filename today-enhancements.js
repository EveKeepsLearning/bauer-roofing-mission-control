...
(function(){
  ...
  async function refreshAfterChange(message,type='success'){
    ...
    moveCurrentTaskIntoList();syncTodayClass();
  ...
  async function install(){
    ...
    try{renderDashboard();moveCurrentTaskIntoList();}catch(error){console.warn('Today enhancement initial render deferred',error);}
  }
